...
var _messages = __webpack_require__(337);
...
var _users = __webpack_require__(335);

var _users2 = __webpack_require__(336);
...
const usersController = () => {
    (0, _users3.default)('#users', _users.users);
};
...
const users = [{ name: 'John' }, { name: 'Roman' }, { name: 'Andrew' }];
...
const usersView = (selector, users) => {
...
var _messages = __webpack_require__(338);

var _messages2 = _interopRequireDefault(_messages);

var _newMessageForm = __webpack_require__(339);

var _newMessageForm2 = _interopRequireDefault(_newMessageForm);
...
const messagesController = () => {
    ...
    (0, _messages2.default)('#messages', _messages3.messages, {
        onDelete: message => _messages3.messages.remove(message)
    });

    const form = (0, _newMessageForm2.default)('#new-message-form', {
        onSend: text => {
            _messages3.messages.add({ text: text });
            if (form) {
                form.clear();
            }
        }
...
const messagesView = (selector, messages, callbacks) => {
    const list = document.querySelector(selector);
    if (list) {
        const template = list.querySelector('ul > li');
        if (template && template.parentNode) {
...
const newMessageFormView = (selector, callbacks) => {
...
exports.default = newMessageFormView;
...
var _messagesArray = __webpack_require__(341);

var _messagesArray2 = _interopRequireDefault(_messagesArray);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const messages = new _messagesArray2.default();

messages.add([{ text: 'hello' }, { text: 'hi' }, { text: 'bye' }]);
...
class MessagesArray extends Array {
